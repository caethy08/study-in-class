...
if(!(id.equals("aa") && pwd.equals("11"))){
	response.sendRedirect("jsp4member.html");  //response : client로 결과 출력 서버가 클라이어트를 통해서(get방식) jsp4member.html파일을 요청 
}
...
<body>
** 전송된 입력 자료 확인 ** <br>
아이디는 <% out.println(id + "<br>"); //out은 내장객체(출력 스트림 개체) %>
...
Server CharacterEncoding: <%= response.getCharacterEncoding() %>
<br>
