...
//String name = request.getParameter("name");  //과거 버전
%>    
...
....
 -->    
 <jsp:setProperty property="*" name="bean"/>  <!-- property="*" : 수신 된 값이 자동으로(약속에 의해) ExamBean의 멤버 필드에 저장  -->
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<jsp:setProperty property="bean" name="process" value="<%=bean %>"/> <!-- setBean을 부르는 것 -->
