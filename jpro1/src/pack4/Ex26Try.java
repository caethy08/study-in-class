...
//예외처리: 키보드, 파일처리, 네트워트, DB연동 처리 등 외부와 접속을 통한 프로그래밍 작업 중 
//예상치 못한 에러가 발생할 수 있는대 이와 같은 경우에 주로 사용한다
//try ~ catch 구문을 사용
...
public class Ex26Try {
	...
	public void testMethod() {
		...
		try {
			...
			System.out.println("testMethod 오류 : " + e); //지역 우선
		}
	...
	public static void main(String[] args){
		...
		try {
			...
			//e2.printStackTrace();
			System.out.println("객체 변수 에러 원인은 " + e2.getMessage()); //e2와 e2.getmessage는 같은 이야기
