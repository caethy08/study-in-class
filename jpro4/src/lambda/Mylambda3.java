...
public class Mylambda3 {
	...
	private void test1() {
		...
		System.out.println();
		//위 for문을 람다식 사용
		//forEach는 Consummer 한수형 인터페이시의 인스턴스를 받아, 각 요소에 대한 작업을정의한다
		// Consummer : 반환 값이 없으며, 1개의 매개변수를 받아들이고 반환 값이 없는 accept()를 정의
		list.forEach(i -> System.out.println(i)); 
	}
	
	//내부 클래스
	class ThreadTest{
		private void sendData(String friend) {
