...
String adminPass = "*****"; //로그인 안하면 비밀번호 안보이기

//회원 가입 후 로그인에 성공하면 세션 생성한다고 가정하고 세션 읽기
String adminOk = (String)session.getAttribute("adminOk"); 
if(adminOk != null){
	if(adminOk.equalsIgnoreCase("admin")) adminPass = pass; //adminPass는 세션이 없으면 "*****"이고 있으면 비번을 가진다
}
%>
<!DOCTYPE html>
<html>
...
<table>
	<tr>
		...
		<td colspan="2" style="text-align: right;">
			...
			</a>  <%-- 보드리스트로 돌아갈 떄는 num을 가지고 가지 않고 page만 가지고 간다. --%>			
		</td>
	</tr>
	<tr>
		<td>
	...
	<tr>
		<td colspan="3">
			<textarea rows="10" style="width: 100%" readonly><%=cont%></textarea>
		</td>
	</tr>
</table>
</body>
