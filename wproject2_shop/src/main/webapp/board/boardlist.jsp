...
<table>
	<tr>
		<td>
			...
			<a href="#" onclick="window.open('admin.jsp','', 'width=300, height=150, top=200,left=300')">최근목록</a>&nbsp;
			<br><br>
			<table style="width: 100%">
				...
				//ArrayList<BoardDto> list = boardMgr.getDataAll(); //페이지 수를 안줘서 getDataAll이 에러
				//ArrayList<BoardDto> list = boardMgr.getDataAll(spage); //조회만 할때
